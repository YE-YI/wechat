/**所有使用JS-SDK的页面必须先注入配置信息 ，否则无法调用
 * Created by 睿哥 on 2017/03/16.
 */

var wx_config_url = "getWxConfig";
//获取微信config 4个属性参数
function getWx_config(url) {
	var params = {
		'page_url': url
	}
	getReqPromise(wx_config_url, params).then(function (ret) {
